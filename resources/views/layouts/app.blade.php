...
<div class="nav-main">
    ...
    <a class="delivery" href="#site-footer"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21s7-6.2 7-13A7 7 0 1 0 5 8c0 6.8 7 13 7 13Zm0-10a3 3 0 1 1 0-6 3 3 0 0 1 0 6Z"/></svg><span><small>Delivering to</small><b>Canada</b></span></a>
    ...
    <button class="language" type="button" aria-label="Language">🇨🇦 <b>EN</b>⌄</button>
    <a class="nav-account" href="{{route('checkout.create')}}"><small>Hello, sign in</small><b>Account &amp; Lists⌄</b></a>
    <a class="nav-orders" href="{{route('cart.index')}}"><small>Returns</small><b>&amp; Orders</b></a>
    <a class="cart-link" href="{{route('cart.index')}}"><span class="cart-icon"><svg viewBox="0 0 32 27"><path d="M2 2h4l3.2 15.5h15.6L29 7H8M11 24h.1M24 24h.1"/></svg><b>{{array_sum(session('cart',[]))}}</b></span><strong>Cart</strong></a>
</div>
